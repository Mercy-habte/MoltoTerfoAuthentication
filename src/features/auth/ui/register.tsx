...
const Register = () => {
  ...
  const handleSubmit = (values) => {
   ...
   dispatch(LOG_g("handleSubmit", data))
      if (validator.isEmpty(data.email) || validator.isEmpty(data.password) ||validator.isEmpty(data.name)) {
        ...
        >
          <Card hoverable style={{ width: "500px" }}>
            ...
            <Form  onFinish={handleSubmit}>
              ...
              {/* ----------------   email  -------------------   */}
              <Form.Item
                  // initialValue={"se.mercy.habte@gmail.com"}
                  name="email"
